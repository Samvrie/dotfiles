...
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/samvrie/dotfiles/mac/configure.sh)"
```
...
[Fork holman's](https://github.com/holman/dotfiles/fork) or [Fork mine](htps://github.com/samvrie/dotfiles/fork), remove what you don't
...
[open an issue](https://github.com/samvrie/dotfiles/issues) on this repository
